...
class clientinformationadaptor (private val context: Activity, private val arrayList: ArrayList<clientinformationdata>):
    ArrayAdapter<clientinformationdata>(context,
